import {MazeAlgorithm, Node, StatRecord, StatusChange} from '../../../../types';
...
export abstract class MazeAlgorithmAbstract {
  ...
  public abstract updateAlgorithmState(newGrid: Node[][], algorithmState: any, statRecords: StatRecord[]): void;
   ...
   */
  public abstract deserialize(newGrid: Node[][], serializedState: any, statRecords: StatRecord[]): void;
